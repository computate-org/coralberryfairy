...
public class DollEnUSGenApiServiceImpl extends BaseApiServiceImpl implements DollEnUSGenApiService {
	...
	public Future<JsonObject> generatePageBody(ComputateSiteRequest siteRequest, Map<String, Object> ctx, String templatePath, String classSimpleName) {
		...
		try {
			...
			page.persistForClass(Doll.VAR_labelsString, Doll.staticSetLabelsString(siteRequest2, (String)result.get(Doll.VAR_labelsString)));
			page.persistForClass(Doll.VAR_labels, Doll.staticSetLabels(siteRequest2, (String)result.get(Doll.VAR_labels)));
